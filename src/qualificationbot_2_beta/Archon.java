...
public class Archon {
    ...
    public static void run() throws GameActionException {
        ...
        while (exploreIndex < exploreBlocksListSize) {
            ...
            // expand east/west
            if (block.x < myBlock.x) {
                addExploreBlock(block.add(Direction.WEST));
            } else if (block.x > myBlock.x) {
                addExploreBlock(block.add(Direction.EAST));
            }

            // expand north/south
            if (block.y < myBlock.y) {
                addExploreBlock(block.add(Direction.SOUTH));
            } else if(block.y > myBlock.y) {
                addExploreBlock(block.add(Direction.NORTH));
            }
        }
...
//                });
        ...
        // TODO might want to iterate through this list backwards?
