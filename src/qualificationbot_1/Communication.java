...
public class Communication {
    ...
    public static final int NO_LEAD_BLOCKS_SIZE = BLOCK_LOC_SIZE * 15;
    public static final int NO_ENEMY_BLOCKS_SIZE = BLOCK_LOC_SIZE * 15;
    public static final int MINEABLE_BLOCKS_SIZE = BLOCK_LOC_SIZE * 7;
    public static final int UNMINEABLE_BLOCKS_SIZE = BLOCK_LOC_SIZE * 7;
    public static final int ENEMY_THREAT_BLOCKS_SIZE = BLOCK_LOC_SIZE * 7;
    public static final int ENEMY_NONTHREAT_BLOCKS_SIZE = BLOCK_LOC_SIZE * 7;
    ...
    public static boolean addBlockInfo(int blockType, MapLocation block) throws GameActionException {
        ...
        if (size + 1 >= ((blockType >= BLOCK_TYPE_MINEABLE) ? 8 : 16)) return false;
